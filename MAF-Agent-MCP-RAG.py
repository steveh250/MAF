...
async def run_agent():
    ...
    agent = chat_client.create_agent(
        ...
        """,
        tools=[docling_tool, add_knowledge_tool, query_knowledge_tool]
    )
